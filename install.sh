...
INSTALLER_VERSION='0.1.0-rc.17'
RELEASE_TAG='v0.1.0-rc.17'
REPOSITORY='alieismy/debian-vps-tuning'
EXPECTED_MANIFEST_SHA256='d44284ed010a5a9774fc104cea50a51bd209f8e0d1e57b9680cdf147e5bdc208'
...
Remote mode downloads only the fixed v0.1.0-rc.17 Release. It first verifies
