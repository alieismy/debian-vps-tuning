...
INSTALLER_VERSION='0.1.0-rc.16'
RELEASE_TAG='v0.1.0-rc.16'
REPOSITORY='alieismy/debian-vps-tuning'
EXPECTED_MANIFEST_SHA256='01736d46101b306db0ef167a7a3724107d2e95d056287e9bb2d18953c6053616'
...
Remote mode downloads only the fixed v0.1.0-rc.16 Release. It first verifies
