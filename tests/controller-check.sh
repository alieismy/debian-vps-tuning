...
release_is_newer v0.1.0-rc.16 0.1.0-rc.15 || fail 'rc.16 was not newer than rc.15'
...
if release_is_newer v0.1.0-rc.15 0.1.0-rc.16; then
...
[
  ...
  {"tag_name":"v0.1.0-rc.16","draft":false},
...
jq() {
  printf '%s\n' v0.1.0-rc.9 v0.1.0-rc.16 v0.1.0-rc.15 v0.1.0-rc.14 v0.1.0-rc.13 v0.1.0-rc.12 v0.1.0-rc.10 v0.2.0 v1.0.0 nightly
}
[ "$(select_highest_release_tag "$release_fixture" 0.1.0-rc.15)" = 'v0.1.0-rc.16' ] ||
...
ACTION=''
CLI_UPDATE_TAG=''
parse_arguments update --target v0.1.0-rc.16
if [ "$ACTION" != update ] || [ "$CLI_UPDATE_TAG" != v0.1.0-rc.16 ]; then
...
resolve_update_release() { UPDATE_TAG_SELECTED='v0.1.0-rc.16'; }
