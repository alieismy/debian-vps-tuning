...
test "$(readlink -f "${prefix}/lib/debian-vps-tuning/current")" = \
  "${prefix}/lib/debian-vps-tuning/0.1.0-rc.18"
test "$("${prefix}/bin/dvt" --version)" = 'controller=0.1.0-rc.18 release=v0.1.0-rc.18'
(
...
printf '\n# tamper fixture\n' >>"${prefix}/lib/debian-vps-tuning/0.1.0-rc.18/dvt-probe.sh"
...
grep -Fq '# tamper fixture' "${prefix}/lib/debian-vps-tuning/0.1.0-rc.18/dvt-probe.sh"
