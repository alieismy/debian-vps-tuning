...
test "$(readlink -f "${prefix}/lib/debian-vps-tuning/current")" = \
  "${prefix}/lib/debian-vps-tuning/0.1.0-rc.14"
test "$("${prefix}/bin/dvt" --version)" = 'controller=0.1.0-rc.14 release=v0.1.0-rc.14'
(
...
printf '\n# tamper fixture\n' >>"${prefix}/lib/debian-vps-tuning/0.1.0-rc.14/dvt-probe.sh"
...
grep -Fq '# tamper fixture' "${prefix}/lib/debian-vps-tuning/0.1.0-rc.14/dvt-probe.sh"
